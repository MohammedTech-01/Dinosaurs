...
first of all, this program compares you with dinosaurs and give you some fact about dinosaurs every time you compare yourself with dinosaurs.
how to use this website?
first, you need to enter your name (you don't need to enter your real name).
second, you need to enter your height in feet or height or both don't matter but you must enter one of them.
third, you must enter your weight in lbs(you can search in google to convert any Unit to lbs).
last, you choose what is your diet to compare it with dinosaurs who are like you or not.

after that, the form of data will show you, and if you want to try other information just refresh the page.
